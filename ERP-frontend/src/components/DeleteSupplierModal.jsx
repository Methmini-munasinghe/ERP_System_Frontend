...
export default function DeleteSupplierModal({ isOpen, onClose, onConfirm, isDeleting, supplier }) {
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-center text-lg font-semibold mb-6 text-gray-800">
            Do you really want to delete the supplier{supplier ? ` \"${supplier.fullName || supplier.contactName || ''}\"` : ''}!<br />Are you sure?
          </p>
